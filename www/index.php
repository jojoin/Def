...
<!--微博-->
<div id="weibo">
    <iframe width="100%" height="326" class="share_self"  frameborder="0" scrolling="no" src="http://widget.weibo.com/weiboshow/index.php?language=&width=0&height=326&fansRow=2&ptype=1&speed=0&skin=5&isTitle=1&noborder=1&isWeibo=1&isFans=1&uid=5888762623&verifier=e5c5ac2e&dpc=1"></iframe>
</div>
...
<div id="content">
    ...
    <p>如果要了解 Def 语言全部的特征，请查看 <a href="https://github.com/jojoin/Def/tree/master/test" target="_blank">标准测试代码</a> 示例。</p>
</div>
